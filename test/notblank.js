...
const SCENES = [
  ...
  ['departure', 'new DepartureScene()'],
  ['departure-gate', "(()=>{const S=new DepartureScene();S.body.x=6700;S.cam.snapTo(6700,S.floorY(1));return S;})()"],
  ['jetbridge', 'new JetBridgeScene()'],
  ['plane-seated', 'new PlaneScene({ seated: true })'],
  ['inflight-film', "(()=>{const tv=new PlaneTvScene(()=>new PlaneScene({seated:true}),PLANE_MOVIES[0]);tv.play={m:PLANE_MOVIES[0],t:40};tv.mode='play';tv.modeT=9;return tv;})()"],
