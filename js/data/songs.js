...
const OPERA = {
  title: 'RHAPSODY OF THE BUG',
  movements: [
    { key: 'intro', title: 'I. IS THIS REAL LIFE', instrument: 'piano', bpm: 72, style: 'opera', difficulty: 1, key_: 57, chords: [0, 3, 5, 4],
      lights: ['#c58bff', '#5bc0ff'], pyro: 0,
      notes: [[69,1],[72,1],[76,2],[75,1],[72,1],[71,2],[69,1],[71,1],[72,2],[71,1],[69,1],[64,2],
              [69,1],[72,1],[76,2],[79,1],[76,1],[74,2],[72,1],[71,1],[69,2],[69,4]],
      tutorial: 'NOTES FALL - PRESS THE KEY UNDER THEM' },
    { key: 'ballad', title: 'II. THE BALLAD', instrument: 'piano', bpm: 84, style: 'ballad', difficulty: 2, key_: 57, chords: [0, 4, 5, 3, 0, 4, 0, 0],
      lights: ['#5bc0ff', '#ffd24a'], pyro: 1,
      notes: [[76,1],[76,.5],[74,.5],[72,1],[69,1],[71,1],[72,1.5],[71,.5],[69,2],
              [72,1],[72,.5],[71,.5],[69,1],[67,1],[69,1],[71,1.5],[69,.5],[67,2],
              [76,1],[79,1],[81,2],[79,1],[76,1],[74,2],[72,1],[74,1],[76,4]],
      tutorial: 'HOLD THE LONG NOTES. GOLD STARS PAY TRIPLE.' },
    { key: 'solo', title: 'III. THE GUITAR SOLO', instrument: 'guitar', bpm: 128, style: 'rock', difficulty: 3, key_: 57, chords: [0, 5, 3, 4],
      lights: ['#ff5a5a', '#ffb340'], pyro: 2,
      notes: [[69,.5],[72,.5],[76,.5],[79,.5],[81,1],[79,.5],[76,.5],[77,.5],[76,.5],[74,.5],[72,.5],[69,1],
              [67,.5],[71,.5],[74,.5],[79,.5],[78,1],[76,.5],[74,.5],[72,.5],[71,.5],[69,.5],[67,.5],[64,1],
              [69,.25],[71,.25],[72,.25],[74,.25],[76,.25],[77,.25],[79,.25],[81,.25],[83,.5],[81,.5],[79,.5],[76,.5],[81,2]],
      tutorial: 'BEND THE STRINGS. RED BOMBS: LET THEM PASS.' },
    { key: 'opera', title: 'IV. THE OPERA', instrument: 'drums', bpm: 136, style: 'opera', difficulty: 4, key_: 60, chords: [0, 3, 4, 0, 5, 3, 4, 0],
      lights: ['#ffd24a', '#ffffff', '#ff5ab0'], pyro: 3,
      notes: [[72,.5],[72,.5],[72,.5],[76,.5],[74,1],[72,1],[71,.5],[71,.5],[71,.5],[74,.5],[72,1],[71,1],
              [69,.5],[69,.5],[72,.5],[76,.5],[79,1],[76,1],[74,.5],[72,.5],[71,.5],[69,.5],[72,2],
              [76,.5],[76,.5],[76,.5],[79,.5],[81,1],[79,1],[77,.5],[76,.5],[74,.5],[72,.5],[76,2]],
      tutorial: 'RED DON = F OR J. BLUE KA = D OR K. BIG NOTES: BOTH.' },
    { key: 'rock', title: 'V. SO YOU THINK YOU CAN ROCK', instrument: 'guitar', bpm: 152, style: 'concert', difficulty: 5, key_: 57, chords: [0, 0, 5, 5, 3, 3, 4, 4],
      lights: ['#ff2a2a', '#ffb340', '#ffffff'], pyro: 4,
      notes: [[57,.25],[57,.25],[64,.5],[57,.25],[57,.25],[63,.5],[57,.25],[57,.25],[62,.5],[60,.5],[59,.5],
              [57,.25],[57,.25],[64,.5],[57,.25],[57,.25],[63,.5],[69,.5],[67,.5],[64,.5],[62,.5],
              [69,.25],[72,.25],[76,.25],[81,.25],[79,.5],[76,.5],[74,.25],[76,.25],[79,.25],[81,.25],[84,1]],
      tutorial: 'FASTER. KEEP THE COMBO ALIVE.' },
    { key: 'impossible', title: 'VI. NOTHING REALLY MATTERS', instrument: 'guitar', bpm: 184, style: 'concert', difficulty: 9, key_: 57, chords: [0, 5, 3, 4], impossible: true,
      lights: ['#ff2a2a', '#ffffff'], pyro: 5,
      notes: [[81,.25],[79,.25],[76,.25],[74,.25],[72,.25],[74,.25],[76,.25],[79,.25]],
      tutorial: 'THE SOLO. NOBODY HAS EVER LANDED IT LIVE.' },
  ],
};
