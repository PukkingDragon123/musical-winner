...
const NODES = [
  ...
  { id: 'shinjuku', x: 300, y: 205, name: 'SHINJUKU STATION', type: 'venue', venue: 'metro', icon: 'gig', sub: 'BUSIEST ON EARTH' },
  ...
  // ---- Nakano / Shimokita
  { id: 'nakano', x: 150, y: 248, name: 'NAKANO BROADWAY', type: 'shop', icon: 'shop', sub: 'FIGURES AND ODDITIES' },
  ...
  { id: 'shibuyasta', x: 400, y: 492, name: 'SHIBUYA STATION', type: 'venue', venue: 'metro', icon: 'gig', sub: 'UNDERGROUND ACOUSTICS' },
  ...
  { id: 'radio', x: 760, y: 175, name: 'RADIO KAIKAN', type: 'shop', icon: 'shop', sub: 'PARTS AND FIGURES' },
